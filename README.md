...
$ ./fbpt -h
usage: fbpt [-h]
            {classify,rename,create,mkdir,remove,write,copy,move,split,merge,chmod,find,check-name,check-integrity,deduplicate,hash,compress,encrypt,decrypt,convert}
            ...
